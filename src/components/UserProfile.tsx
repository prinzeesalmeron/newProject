...
export const UserProfile: React.FC<UserProfileProps> = ({ isOpen, onClose }) => {
  const { isConnected, address, balance, disconnect, provider } = useWalletConnector();
                  ...
                  <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      <div>
                        ...
                        <p className="text-xs text-green-700 dark:text-green-300 mt-1 capitalize font-semibold">
                          {provider === 'metamask' ? 'MetaMask' :
                           provider === 'coinbase' ? 'Coinbase Wallet' :
                           provider === 'phantom' ? 'Phantom' :
                           provider === 'trust' ? 'Trust Wallet' :
                           'Wallet'}
                        </p>
                      </div>
