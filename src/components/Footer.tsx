        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/staking" className="text-sm text-gray-600 hover:text-blue-600 transition-colors">
                  Staking
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/learn" className="text-sm text-gray-600 hover:text-blue-600 transition-colors">
                  Learn
                </Link>
              </li>
            </ul>
